...
- template: body-copy
  content: |-
    ...
    Core learning values such as team work, learning by doing and observation, identifying problems, tackling challenges are subtly embedded in the programs curriculum
- template: images
  images:
